...
public class URLUtilsTest {
	...
	public void testToUrl() throws Exception {
		...
		assertEquals("http://127.0.0.1:8888/CHK@u5oOFflfB9hxxe2C9ZQKb8i1dSHlJY6b1P0ReEvWkus,H4cVvTp4WAhKAC~Bv-8mDg18h7ngjO0tRHSUR3rXAO8,AAIC--8/Freenet-Knowledge-v0.1.0-0.tar.gz", urlUtils.toURL(url));
